...
export default function ImportProductsModal({ open, onClose, ownerId, subOwnerId, branchOwnerId, existingProducts }) {
    ...
    try {
      ...
      for (let i = 0; i < rows.length; i += CHUNK_SIZE) {
        ...
        chunk.forEach((row) => {
          ...
          batch.set(ref, { ...row, ownerId, subOwnerId, branchOwnerId, createdAt: serverTimestamp() })
        })
        await batch.commit()
      }
